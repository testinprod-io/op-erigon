...
const file_types_types_proto_rawDesc = "" +
	...
	"\x05patch\x18\x03 \x01(\rR\x05patch\"\xd8\x06\n" +
	...
	"\x0fexcess_blob_gas\x18\x12 \x01(\x04H\x01R\rexcessBlobGas\x88\x01\x01\x129\n" +
	"\x0fwithdrawls_root\x18\x13 \x01(\v2\v.types.H256H\x02R\x0ewithdrawlsRoot\x88\x01\x01B\x10\n" +
	"\x0e_blob_gas_usedB\x12\n" +
	"\x10_excess_blob_gasB\x12\n" +
	"\x10_withdrawls_root\"\x8a\x01\n" +
	"\n" +
	"Withdrawal\x12\x14\n" +
