...
func (c *downloaderClient) SetLogPrefix(ctx context.Context, in *SetLogPrefixRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Downloader_SetLogPrefix_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *downloaderClient) Completed(ctx context.Context, in *CompletedRequest, opts ...grpc.CallOption) (*CompletedReply, error) {
	...
	err := c.cc.Invoke(ctx, Downloader_Completed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *downloaderClient) TorrentCompleted(ctx context.Context, in *TorrentCompletedRequest, opts ...grpc.CallOption) (Downloader_TorrentCompletedClient, error) {
	stream, err := c.cc.NewStream(ctx, &Downloader_ServiceDesc.Streams[0], Downloader_TorrentCompleted_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &downloaderTorrentCompletedClient{stream}
...
func _Downloader_TorrentCompleted_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DownloaderServer).TorrentCompleted(m, &downloaderTorrentCompletedServer{stream})
}
