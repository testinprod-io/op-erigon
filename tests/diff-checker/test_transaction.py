...
def test_eth_getTransactionReceipt(bedrock):
    ...
    for tx_hash in tx_hashes:
        geth_receipt = geth_client.send_request(RPCMethod.GetTransactionReceipt, [tx_hash])
        erigon_receipt = erigon_client.send_request(RPCMethod.GetTransactionReceipt, [tx_hash])
