...
DOCKER_TAG ?= testinprod/erigon:latest
...
PACKAGE = github.com/testinprod/erigon
...
PACKAGE_NAME          := github.com/testinprod-io/erigon
...
.PHONY: hive
hive:
	DOCKER_TAG=testinprod/erigon:ci-local make docker
