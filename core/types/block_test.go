...
func TestTxDependencyBlockDecoding(t *testing.T) {
	...
	blockEnc := libcommon.FromHex("")
...
func TestBlockEncoding(t *testing.T) {
	t.Parallel()
	blockEnc := libcommon.FromHex("")
	var block Block
	if err := rlp.DecodeBytes(blockEnc, &block); err != nil {
		t.Fatal("decode error: ", err)
	}
	...
	check("Time", block.Time(), uint64(1426516743))
	check("Size", block.Size(), libcommon.StorageSize(len(blockEnc)))
...
func TestEIP1559BlockEncoding(t *testing.T) {
	t.Parallel()
	blockEnc := libcommon.FromHex("")
	var block Block
	if err := rlp.DecodeBytes(blockEnc, &block); err != nil {
		t.Fatal("decode error: ", err)
	}
...
func TestEIP2718BlockEncoding(t *testing.T) {
	t.Parallel()
	blockEnc := libcommon.FromHex("")
	var block Block
	if err := rlp.DecodeBytes(blockEnc, &block); err != nil {
		t.Fatal("decode error: ", err)
	}
...
func makeBenchBlock() *Block {
	...
	return NewBlock(header, txs, uncles, receipts, nil /* withdrawals */, false)
}
...
func TestAuRaHeaderEncoding(t *testing.T) {
	...
	header := Header{
		...
		GasUsed:     3_074_345,
		Time:        1666343339,
		Extra:       libcommon.FromHex("0x1234"),
		BaseFee:     big.NewInt(7_000_000_000),
		AuRaStep:    13078,
		AuRaSeal:    libcommon.FromHex("0x75bda30f85541be059646e1acd3613fd100846e42308df2dad8ed79b9a9e91c9db994386599a683820a1394684d41fc139c4805684142e6b15a722a2e9cc51f7ee"),
	}
...
func TestWithdrawalsEncoding(t *testing.T) {
	...
	block := NewBlock(&header, nil, nil, nil, withdrawals, false)
	_ = block.Size()
	...
	block2 := NewBlock(&header, nil, nil, nil, []*Withdrawal{}, false)
	_ = block2.Size()
