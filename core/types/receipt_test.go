...
func TestDeriveFields(t *testing.T) {
	...
	if err := receipts.DeriveFields(params.TestChainConfig, hash, number.Uint64(), txs, []common.Address{common.BytesToAddress([]byte{0x0}), common.BytesToAddress([]byte{0x0}), common.BytesToAddress([]byte{0x0})}); err != nil {
