...
var TestCanyonTime = *big.NewInt(10)
var TestHoloceneTime = *big.NewInt(12)
var TestJovianTime = *big.NewInt(14)
...
func TestCalcBaseFeeJovian(t *testing.T) {
	...
	preJovian := TestHoloceneTime.Uint64()
	postJovian := TestJovianTime.Uint64()
	...
	for i, test := range tests {
		...
		t.Run(testName, func(t *testing.T) {
			...
			parent.Extra = EncodeOptimismExtraData(opConfig(), test.parentTime, uint32(denom), uint32(elasticity), &test.minBaseFee)
